...
public class PlayerOscuroController : MonoBehaviour
{
    ...
    IEnumerator EmpezarMoviemientos()
    {
        ...
        if (alcanzadoFin) // si se ha alzado el fin
        {
            ...
            SceneManager.LoadScene("NivelesAleatoriosOscuros"); // Cargamos la pantalla anterior
        }
    ...
    {
        PlayerPrefs.SetInt("nivelOscuros", bonus);
    }
